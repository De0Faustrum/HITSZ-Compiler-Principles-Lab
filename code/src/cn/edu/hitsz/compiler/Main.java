...
public class Main {
    public static void main(String[] args) {
        ...
        final var tokens = lexer.getTokenList();
        symbolTable.dumpTable(FilePathConfig.OLD_SYMBOL_TABLE);
        System.out.println("LEXICAL ANALYSIS ACCOMPLISHED");
        System.out.println("=============================================\n");
        ...
        // 加载 LR 分析驱动程序
        System.out.println("=============================================");
        System.out.println("SYNTAX ANALYSIS BEGIN");
        ...
        System.out.println("SYNTAX ANALYSIS ACCOMPLISHED");
        System.out.println("=============================================\n");
